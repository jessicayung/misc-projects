...
def print_economy_parameters():
    print("Absolute values printed are used as starting values in \
            dynamic models or apply if the model assumes \
            variables are exogenous.\n")
    print("Consumption coefficients: ", C_cfs)
    print("Investment coefficients: ", I_cfs, "\n")
    print("Investment: ", I_exog)
    print("Government spending: ", G_exog)
    print("Tax: ", T_exog)
    print("Money supply: ", M_exog)
    print("Price level (domestic): ", P_df)
    print("Price level (foreign): ", Pstar_df)
    print("Interest rate (foreign): ", istar_df)
    print("Expected exchange rate : ", exp_e_df)
    print("Expected inflation: ", pi_e_df)
    if short_run:
        print("Timeframe: Short run.")
    else:
        print("Timeframe: Long run.")
